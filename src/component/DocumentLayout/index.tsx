                        ...
                        <div className="browser-content">
                            ...
                            <div className="content">
                                <div className="header">
                                    <Button size='small' type='link'><ArrowLeftOutlined /></Button>
                                    <Button size='small' type='link'><ArrowRightOutlined /></Button>
                                    <Input prefix={<SearchOutlined />} placeholder='搜索，也可以输入文档地址直接打开' />
                                </div>
                                <Breadcrumb
                                    items={[
                                        {
                                        ...
                                        <div className="sc-dPWrhe haxPzc">
                                            <div className="sc-h2trro-0 sc-h2trro-2 dDZsbk ikwVWX J_console_base_body_for_feedback">
                                                <header className="sc-ezOQGI kxjtjj">
                                                    <h1 className="sc-fEXmlR gokncu">云原生数据仓库AnalyticDB MySQL版（ADB）3.0</h1>
                                                    <time>更新时间：2023年10月30日 18:31:00</time>
                                                </header>
                                                <div className="sc-gYbzsP heHuVN">
                                                    <article className="sc-69ecu8-0 sc-bYMpWt lgEDzt jdJPqc">
                                                        <main>
                                                            <p>本文为您介绍如何使用云原生数据仓库AnalyticDB MySQL版3.0连接器。</p>
                                                            <div>
                                                                <section id="section-boo-btx-sbo" data-type="section">
                                                                    <h2 id="title-thu-qlk-evh">背景信息</h2>
                                                                    <p>
                                                                        <a href="//help.aliyun.com/document_detail/93776.html#concept-n4h-2rr-vy">云原生数据仓库AnalyticDB MySQL版3.0</a>是融合数据库、大数据技术于一体的云原生企业级数据仓库服务。AnalyticDB MySQL版支持高吞吐的数据实时增删改、低延时的实时分析和复杂ETL，兼容上下游生态工具，可用于构建企业级报表系统、数据仓库和数据服务引擎。
                                                                    </p>
                                                                    <div>
                                                                        ...
                                                                        <div data-console-base-html-table-wrap="">
                                                                            ...
                                                                            <div data-console-base-html-table-wrap-inner="">

                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </section>
                                                                <section id="section-rit-7mt-ux6" data-type="section">
                                                                    <h2 id="title-0mq-b47-l7d">前提条件</h2>
                                                                    <ul>
                                                                        <li>
                                                                            <p>已创建AnalyticDB MySQL集群并创建表，详情请参见<a href="//help.aliyun.com/document_detail/122234.html#task1307">创建集群</a>和<a href="//help.aliyun.com/document_detail/123333.html#concept-2138836">CREATE TABLE</a>。</p>
                                                                        </li>
                                                                        <li>
                                                                            <p>已设置白名单，详情请参见<a href="//help.aliyun.com/document_detail/122244.html#task-2195045">设置白名单</a>。</p>
                                                                        </li>
                                                                    </ul>
                                                                </section>
                                                                <section id="section-q5v-8od-8ec" data-type="section">
                                                                    <h2 id="title-xc6-j5t-v3r">使用限制</h2>
                                                                    <ul>
                                                                        <li>
                                                                            <p>仅支持作为维表和结果表，不支持作为源表。</p>
                                                                        </li>
                                                                        <li>
                                                                            <p>仅Flink计算引擎VVR 3.x及以上版本支持云原生数据仓库AnalyticDB MySQL版3.0连接器。</p>
                                                                        </li>
                                                                    </ul>
                                                                </section>
                                                                <section id="section-x85-lw6-thz" data-type="section">
                                                                    ...
                                                                    <div data-console-base-html-pre-wrap="">
                                                                        ...
                                                                        <pre>CREATE TEMPORARY TABLE adb_table (
                                                                            `id` INT,
                                                                            `num` BIGINT,
                                                                    ...
                                                                    <div data-console-base-html-note="help">
                                                                        <strong>重要 </strong>
                                                                        <p>
                                                                            <b>Flink DDL中定义的主键必须和AnalyticDB MySQL数据库物理表中的主键保持一致，主键一致包括是否存在主键和主键名称一致。如果不一致，会影响数据正确性。</b>
                                                                        </p>
                                                                    </div>
                                                                </section>
                                                                <section id="section-hjq-h6j-vub" data-type="section">
                                                                ...
                                                                <section id="section-j28-p23-q82" data-type="section">
                                                                ...
                                                                <section id="section-y4r-al8-h4n" data-type="section">
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            ...
                                                                            <div data-console-base-html-pre-wrap="">
                                                                                ...
                                                                                <pre>CREATE TEMPORARY TABLE datagen_source (
                                                                                    `name` VARCHAR,
                                                                                    `age` INT
                                                                                    ) WITH (
                                                                                        &#39;connector&#39; = &#39;datagen&#39;
                                                                                    ...
                                                                                    SELECT * FROM datagen_source;</pre>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <p>维表</p>
                                                                            <div data-console-base-html-pre-wrap="">
                                                                                ...
                                                                                <pre>CREATE TEMPORARY TABLE datagen_source(
                                                                                    ...
                                                                                    FROM datagen_source AS T JOIN adb_dim FOR SYSTEM_TIME AS OF T.proctime AS H ON T.a = H.a;</pre>
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                                </section>
                                ...
                                <div className="footer">
                                    <Button type="link">文档中心打开 <NewTabOutlined /></Button>
                                </div>
                            </div>
                        </div>
                    </div>
