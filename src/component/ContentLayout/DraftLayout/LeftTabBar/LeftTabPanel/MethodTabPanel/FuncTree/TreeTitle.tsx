...
import { DeleteOutlined, DisconnectOutlined, SettingOutlined, UploadOutlined } from "../../../../../../Icon";
    ...
    return (
        <div className="tree-title">
            <div className="title-wrapper">
                {props.dataNode.title as React.ReactNode}
            </div>
            <div className="actions">

                {
                    props.dataNode.className === "jar" ? (
                        <Space size={4}>
                            <Tooltip title="管理函数"><SettingOutlined onClick={onManagerClick} /></Tooltip>
                            <Tooltip title="更新"><UploadOutlined onClick={onUpdateClick} /></Tooltip>
                            <Tooltip title="删除"><DeleteOutlined onClick={onDropClick} /></Tooltip>
                        </Space>
                ...
                {
                    props.dataNode.className?.includes("function") && !props.dataNode.className?.includes("unregister-function") ? (
                        <Popconfirm
                            okText="确认"
                            cancelText="取消"
                            title='确认要删除该函数？'
                        ...
                        >
                            <Tooltip title="删除函数"><DisconnectOutlined onClick={stopPropagation} /></Tooltip>
                        </Popconfirm>
                    ) : null
