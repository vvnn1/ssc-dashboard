...
import { CopyOutlined, ReloadOutlined } from "../../../../../../../Icon";
...
const MetPopOverpContent = (props: MetaDescriptionProps) => {
    return (
...
const TreeTitle = (props: TreeTitleProps) => {
    return (
        <Popover content={createPopoverContent(props)} placement="right">
            <div className="tree-title">
                ...
                <div className="actions">
                    <Space size={8}>
                        {
                            props.dataNode.className === "catalog" ? <Tooltip title="刷新元数据信息"><ReloadOutlined /></Tooltip> : null
                        }
                        <Tooltip title="复制名称"><CopyOutlined /></Tooltip>
                    </Space>
