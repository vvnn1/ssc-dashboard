        ...
        <div className="session-detail-layout">
                    ...
                    <div className="actions">
                        ...
                        >
                            ...
                            <Button
                                type="link"
                                size="small"
                                onClick={changeStopModalOpen(true)}
                            >
                                停止
                            </Button>
                            <Button
            ...
            <div className="content">
                <div className="session-cluster-detail-navigator">
                    <TabMenu
                        menuItems={menuItems}
                        keyPath={`/workspace/:workspaceId/namespace/:namespaceId/session-clusters/${sessionName}/:key/*`}
                    />
                </div>
            ...
            <StopModal
                open={stopModalOpen}
                onCancel={changeStopModalOpen(false)}
            />
        </div>
    );
};
