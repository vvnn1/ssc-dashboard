...
const NoStyleTableBody: React.FC<NoStyleTableBodyProps> = ({ children }) => {
    return <tbody className="ant-table-body">{children}</tbody>;
};
            ...
            >
                <Table
                    ...
                    dataSource={[
                        ...
                        {
                            key: "env.java.opts",
                            value: "-Djavax.net.ssl.keyStoreType=JKS -Djavax.net.ssl.trustStoreType=JKS -Dlog.file=/flink/log/flink.log -Dstdout.file=/flink/log/flink.out -Dlog4j.configurationFile=/flink/conf.template/log4j2.xml -Djdk.tls.ephemeralDHKeySize=2048 -Dalicloud.sts.credential.provider=sts.file -Dsts.provider.file.credential.root.path=/flink/sts-secrets/sts-credential -Dsts.provider.credential.expire.seconds=900 -Dfile.encoding=UTF-8 -Dkubernetes.max.concurrent.requests=1000",
                        },
                        ...
                        { key: "high-availability.respect-checkpoint-retention-on-shutdown", value: "true" },
                        {
                            ...
                            value: "oss://ssc-b/flink-sessionclusters/namespaces/ssc-m-default/sessionclusters/debug-session/ha",
                        },
                        ...
                        { key: "jobmanager.memory.process.size", value: "4096m" },
                        {
                            ...
                            value: "sessioncluster-c3d0298e-8a85-48b1-a767-659b74d20d1a-jobmanager",
                        },
                        ...
                        {
                            key: "metrics.reporter.promappmgr.factory.class",
                        ...
                        { key: "state.backend.gemini.snapshot.close.file", value: "true" },
                        {
                            ...
                            value: "oss://ssc-b/flink-sessionclusters/namespaces/ssc-m-default/sessionclusters/debug-session/checkpoints",
                        },
                        {
                            key: "state.savepoints.dir",
                            value: "oss://ssc-b/flink-savepoints/namespaces/ssc-m-default/sessionclusters/debug-session",
                        },
