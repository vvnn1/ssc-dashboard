        ...
        items={[
            {
                key: "1",
                label: "快照 ID",
                children: <Tooltip title="81aa2e5c-093b-421b-a403-1b0e3dd7dcf8">81aa2e5c-093b-421b-a403-1b0e3dd7dcf8</Tooltip>
            },
            {
                key: "2",
                label: "完成时间",
...
const OverviewLayout = () => {
    return (
        <>
            ...
            />
            <Descriptions
                title={<>作业快照<span>触发次数：1</span><span>触发次数：1</span><span>已完成：1</span><span>已完成：1</span></>}
                size='small'
                layout="vertical"
                items={[
                    {
