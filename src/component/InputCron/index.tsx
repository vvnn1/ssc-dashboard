    ...
    return (
        <div className="ant-cron-expression-content">
            ...
            <div className="ant-cron-expression-label-group ant-cron-expression-label-group-default">
                <div className="ant-cron-expression-label">分钟</div>
                <div className="ant-cron-expression-label">小时</div>
                <div className="ant-cron-expression-label">日</div>
                <div className="ant-cron-expression-label">月</div>
                <div className="ant-cron-expression-label">周</div>
            </div>
            <div className="ant-collapse ant-collapse-borderless ant-cron-expression-preview">
                <div
                    className={`ant-cron-expression-preview-dateTime ${
                        expand ? "ant-cron-expression-preview-dateTime-center" : null
                    }`}
                >
                    2023-11-08 15:00:00
                </div>
                <div className="ant-cron-expression-preview-content">
                    ...
                    <ul className="ant-cron-expression-preview-icon">
                        <li onClick={onExpandClick}>{expand ? <UpOutlined /> : <DownOutlined />}</li>
                    </ul>
                </div>
            </div>
        </div>
