...
const FileSelect = (props: SelectProps & FileSelectProps) => {
    ...
    return (
        <>
                    ...
                    props.showUpload ? (
                        ...
                        >
                            <Tooltip
                                ...
                                placement="left"
                            >
                                <UploadOutlined style={{ position: "relative", top: "4px" }} />
                            </Tooltip>
                        </Upload>
                    ) : undefined
                }
            ...
            >
                ...
                <Select.Option
                    value="oss://ssc-bucket-v2/artifacts/namespaces/ssc-space-default/WordCount.jar"
                    label="WordCount.jar"
                >
                    <div
                        className="addition-file-item"
                        style={{ display: "flex", justifyContent: "space-between" }}
                    >
                        <span className="file-name">WordCount.jar</span>
                        <span
                            className="operator"
                            onClick={e => {
                                e.stopPropagation();
