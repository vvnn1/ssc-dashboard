...
import { AppstoreOutlined, DatabaseOutlined, FileOutlined } from "../../../../../component/Icon";
import "./index.sass";
...
const LeftTabBar = (props: LeftTabProps) => {
    ...
    return (
        <div className="draft-lef-tab-bar">
            <div
                className={generateClassName("draft")}
                id="draft"
                onClick={onTabClick(<DraftTabPanel />)}
            >
            ...
            <div
                className={generateClassName("catalogs")}
                id="catalogs"
                onClick={onTabClick(<MetaTabPanel />)}
            >
                <span className="tabs-bar-tab-icon">
                    <DatabaseOutlined />
                </span>
            ...
            <div
                className={generateClassName("udf")}
                id="udf"
                onClick={onTabClick(<MethodTabPanel />)}
            >
                <span className="tabs-bar-tab-icon">
                    <AppstoreOutlined />
                </span>
