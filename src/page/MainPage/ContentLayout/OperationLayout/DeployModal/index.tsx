            ...
            <div className="deploy-form-container ">
                ...
                >
                    ...
                    >
                        <Select
                            defaultValue="v1"
                            options={[{ value: "v1", label: "vvr-6.0.7-flink-1.15" }]}
                        />
                    </Form.Item>
                    ...
                    {jobType === "JAR" ? (
                        <div className="jar-module">
                            ...
                            >
                                <Input
                                    placeholder="请输入 Jar URI"
                                    suffix={<UploadOutlined />}
                                />
                            </Form.Item>
                            <Form.Item label="Entry Point Class">
                                <Input placeholder="如果您的 Jar 未指定主类，请在此处输入指向您的 Entrypoint Class 的标准路径" />
                            </Form.Item>
                            <Form.Item label="Entry Point Main Arguments">
                                <TextArea rows={3} />
                            </Form.Item>
                        </div>
                    ) : null}
                    ...
                    {jobType === "PYTHON" ? (
                        <div className="python-module">
                            ...
                            >
                                <Input
                                    placeholder="请输入或选择一个 python 文件地址"
                                    suffix={<UploadOutlined />}
                                />
                            </Form.Item>
                            <Form.Item label="Entry Module">
                                <Input placeholder="请输入 entry module" />
                            </Form.Item>
                            <Form.Item label="Entry Point Main Arguments">
                                <TextArea rows={3} />
                            </Form.Item>
                            <Form.Item label="Python Libraries">
                                <Input
                                    placeholder="请输入或选择任意 python libraries"
                                    suffix={<UploadOutlined />}
                                />
                            </Form.Item>
                            <Form.Item label="Python Archives">
                                <Input
                                    placeholder="请输入或选择任意 python archives"
                                    suffix={<UploadOutlined />}
                                />
                            </Form.Item>
                        </div>
                    ...
                    <Form.Item label="备注">
                        <TextArea
                            placeholder="输入部署备注（可选）"
                            rows={3}
                        />
                    </Form.Item>
                    <Form.Item label="更多设置">
                        <Switch
                            defaultChecked={showMore}
